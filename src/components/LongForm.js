...
const LongForm = () => {
  ...
  return (
    <div className='h-screen w-screen flex justify-center items-center overflow-auto'>
      <form
        className='shadow-lg p-10 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between' onSubmit={submit}
      ...
      >
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex justify-between items-center gap-2 '>
            <button className='bg-indigo-500 text-lg text-white rounded h-10 w-10 ' onClick={()=> dispatch({type: "DECREMENT", payload :{count: 1}})}>
              -
            </button>
            ...
            <button className='bg-indigo-500 text-lg text-white rounded h-10 w-10' onClick={()=> dispatch({type: "INCREMENT", payload :{count: 1}})}>
              +
            </button>
          </div>
        </div>
